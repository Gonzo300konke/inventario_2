                    ...
                    <li class="menu-item active open">
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item active">
                                <a href="?action=index" class="menu-link">
                                    <div data-i18n="Listado de Bienes">Listado de Bienes</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="?action=create" class="menu-link">
...
#### 2. Crear el Archivo de Footer (`layouts/footer.php`)

Este archivo contendría la parte final de tu HTML, incluyendo el pie de página y los scripts de JavaScript.
